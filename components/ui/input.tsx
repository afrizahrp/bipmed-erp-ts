...
export const inputVariants = cva(
  ' w-full   bg-background  border-default-300 dark:border-700  px-3 h-9   text-sm  file:border-0 file:bg-transparent file:text-sm file:font-medium  read-only:leading-9 read-only:bg-background  disabled:cursor-not-allowed disabled:opacity-50 disabled:text-black disabled:font-semibold transition duration-300 ',
  {
    variants: {
      color: {
        default:
