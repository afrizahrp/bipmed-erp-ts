  ...
  return (
    <>
      ...
      <div className='flex md:w-full sm:w-full lg:w-1/2 relative'>
          ...
          />
          <Icon icon="heroicons:magnifying-glass" className="w-3.5 h-3.5 absolute top-1/2 -translate-y-1/2 left-3 text-default-500" />
        </div>
        ...
        <Sheet>
          ...
          <SheetContent>
            ...
            <SheetFooter>
              <SheetClose asChild>
                <Button type='submit' className='w-full'>Back</Button>
              </SheetClose>
            </SheetFooter>
          </SheetContent>
        </Sheet>
